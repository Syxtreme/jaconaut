...
/**
 * @file Kinova.API.EthCommandLayerUbuntu.h
...
#define COMM_LAYER_PATH "libKinova.API.USBCommLayerUbuntu.so"
#define COMM_LAYER_ETHERNET_PATH "libKinova.API.EthCommLayerUbuntu.so"
